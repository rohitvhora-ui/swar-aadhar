        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <View style={styles.action}>
                    ...
                    <TextInput placeholder="Username" style={styles.textInput} autoCapitalize="none" onChangeText={(val) => onChangeText(val)}/>
                ...
                {/* Sign in button */}
                <View>
                    <TouchableOpacity style={[styles.signIn, {color: '#009387', borderWidth: 1, marginTop: 35, borderColor: '#009387'}]}  onPress={() => navigation.navigate("WelcomeScreen")}>
