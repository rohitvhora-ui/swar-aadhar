    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarColor: '#009387',
          tabBarIcon: ({ color }) => (
            <Ionicon name="ios-chatboxes" size={25} color={color}/>
          ),
        }}
      />
    </Tab.Navigator>
...
const QuestionnaireTherapyStackScreen = ({ navigation }) => (
  <QuestionnaireTherapyStack.Navigator screenOptions={{ headerStyle: { backgroundColor: 'cadetblue' }, headerTintColor: '#fff'}}>
      <QuestionnaireTherapyStack.Screen name="QuestionnaireTherapy" component={QuestionnaireTherapy} options={{ title: 'Conversation', headerLeft: () => header(navigation), cardStyle:{backgroundColor: 'white'} }}/>
